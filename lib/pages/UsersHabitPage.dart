...
class UsersHabitPage extends StatefulWidget {
  UsersHabitPage({Key key, this.title}) : super(key: key);
  ...
  @override
  _UsersHabitPageState createState() => _UsersHabitPageState();
}

class _UsersHabitPageState extends State<UsersHabitPage> {
          ...
          child: RaisedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => HabitsPage(user: name)),
                );
              }),
        );
      },
